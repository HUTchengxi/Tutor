...
layui.define("jquery", function (i) {
    ...
    s.prototype.set = function (i) {
        ...
        var e = ".layui-tab-title", l = t(".layui-tab[lay-interceptor=" + i + "]"), n = l.children(e),
        ...
        var e = "layui-progress", l = t("." + e + "[lay-interceptor=" + i + "]"), n = l.find("." + e + "-bar"),
            s = n.find("." + e + "-text");
        ...
        h = "layui-nav-more", f = "layui-anim layui-anim-upbit", y = {
            tabClick: function (i, a, s, o) {
                ...
                var c = s || t(this), a = a || c.parent().children("li").index(c),
                    ...
                    d = c.find("a"), h = r.attr("lay-interceptor");
                ...
                var n = a || t(this).parent(), s = n.index(), o = n.parents(".layui-tab").eq(0),
                    c = o.children(".layui-tab-content").children(".layui-tab-item"), r = o.attr("lay-interceptor");
                ...
                var i = t(this), a = i.parents(o), n = a.attr("lay-interceptor"), s = i.find("a"),
                ...
                var i = t(this), a = i.parents(o), n = a.attr("lay-interceptor");
                ...
                var i = t(this), a = i.find(".layui-colla-icon"), l = i.siblings(".layui-colla-content"),
                    s = i.parents(".layui-collapse").eq(0), o = s.attr("lay-interceptor"), c = "none" === l.css("display");
...
layui.define("layer", function (e) {
        ...
        var n = this, c = t(r + function () {
            ...
            select: function () {
                    ...
                    f = c.find("select"), y = function (i, l) {
                        ...
                        if (!c) {
                            ...
                            f && m.on("keyup", w).on("blur", function (t) {
                                ...
                                var e = t(this), a = e.attr("lay-value"), n = h.attr("lay-interceptor");
                ...
                var e = {
                    ...
                    var a = t(this);
                    e.on("click", function () {
                        var t = a.attr("lay-interceptor"), n = (a.attr("lay-text") || "").split("|");
                ...
                var e = "layui-form-radio", i = ["&#xe643;", "&#xe63f;"], a = c.find("input[type=radio]"),
                    n = function (a) {
                        ...
                        a.on("click", function () {
                            var o = n[0].name, u = n.parents(r), c = n.attr("lay-interceptor"),
    ...
    f.render(), y.on("reset", r, function () {
        var e = t(this).attr("lay-interceptor");
        setTimeout(function () {
            f.render(null, e)
        }, 50)
...
layui.define(["laytpl", "laypage", "layer", "form"], function (e) {
    ...
    var t = layui.$, i = layui.laytpl, a = layui.laypage, l = layui.layer, n = layui.form, o = layui.hint(),
        ...
        w = ".layui-table-sort", N = "layui-table-edit", F = "layui-table-hover", W = function (e) {
            ...
            }(), '<th data-field="{{ item2.field||i2 }}" {{# if(item2.minWidth){ }}data-minwidth="{{item2.minWidth}}"{{# } }} ' + t + ' {{# if(item2.unresize){ }}data-unresize="true"{{# } }}>', '<div class="layui-table-cell laytable-cell-', "{{# if(item2.colspan > 1){ }}", "group", "{{# } else { }}", "{{d.index}}-{{item2.field || i2}}", '{{# if(item2.type !== "normal"){ }}', " laytable-cell-{{ item2.type }}", "{{# } }}", "{{# } }}", '" {{#if(item2.align){}}align="{{item2.align}}"{{#}}}>', '{{# if(item2.type === "checkbox"){ }}', '<input type="checkbox" name="layTableCheckbox" lay-skin="primary" lay-interceptor="layTableAllChoose" {{# if(item2[d.data.checkName]){ }}checked{{# }; }}>', "{{# } else { }}", '<span>{{item2.title||""}}</span>', "{{# if(!(item2.colspan > 1) && item2.sort){ }}", '<span class="layui-table-sort layui-inline"><i class="layui-edge layui-table-sort-asc"></i><i class="layui-edge layui-table-sort-desc"></i></span>', "{{# } }}", "{{# } }}", "</div>", "</th>", e.fixed ? "{{# }; }}" : "", "{{# }); }}", "</tr>", "{{# }); }}", "</thead>", "</table>"].join("")
        },
    ...
    S.prototype.config = {
        ...
        var n, r, c = this, u = {}, h = c.config, f = h.elem.attr("lay-interceptor"), y = d.cache[c.key];
        ...
        u.on("mousemove", function (e) {
            ...
            var e = t(this).prev(), i = a.layBody.find('input[name="layTableCheckbox"]'),
                ...
                o = "layTableAllChoose" === e.attr("lay-interceptor");
        ...
        i = i || {};
        var a = this, l = t(e ? 'table[lay-interceptor="' + e + '"]' : u + "[lay-data]"),
...
layui.define("jquery", function (e) {
    ...
    m.prototype.config = {
        ...
        var n = this, l = n.elemItem, u = n.config, c = u.index, m = u.elem.attr("lay-interceptor");
...
layui.define(["layer", "form"], function (t) {
    ...
    var s = function (t, i, a) {
        ...
        var l = this, n = i.open({
            ...
            title: "超链接",
            skin: "layui-layer-msg",
            content: ['<ul class="layui-form" style="margin: 15px;">', '<li class="layui-form-item">', '<label class="layui-form-label" style="width: 60px;">URL</label>', '<div class="layui-input-block" style="margin-left: 90px">', '<input name="url" lay-verify="url" value="' + (t.href || "") + '" autofocus="true" autocomplete="off" class="layui-input">', "</div>", "</li>", '<li class="layui-form-item">', '<label class="layui-form-label" style="width: 60px;">打开方式</label>', '<div class="layui-input-block" style="margin-left: 90px">', '<input type="radio" name="target" value="_self" class="layui-input" title="当前窗口"' + ("_self" !== t.target && t.target ? "" : "checked") + ">", '<input type="radio" name="target" value="_blank" class="layui-input" title="新窗口" ' + ("_blank" === t.target ? "checked" : "") + ">", "</div>", "</li>", '<li class="layui-form-item" style="text-align: center;">', '<button type="button" lay-submit lay-interceptor="layedit-link-yes" class="layui-btn"> 确定 </button>', '<button style="margin-left: 20px;" type="button" class="layui-btn layui-btn-primary"> 取消 </button>', "</li>", "</ul>"].join(""),
        ...
        var e = this, l = i.open({
            ...
            title: "插入代码",
            skin: "layui-layer-msg",
            content: ['<ul class="layui-form layui-form-pane" style="margin: 15px;">', '<li class="layui-form-item">', '<label class="layui-form-label">请选择语言</label>', '<div class="layui-input-block">', '<select name="lang">', '<option value="JavaScript">JavaScript</option>', '<option value="HTML">HTML</option>', '<option value="CSS">CSS</option>', '<option value="Java">Java</option>', '<option value="PHP">PHP</option>', '<option value="C#">C#</option>', '<option value="Python">Python</option>', '<option value="Ruby">Ruby</option>', '<option value="Go">Go</option>', "</select>", "</div>", "</li>", '<li class="layui-form-item layui-form-text">', '<label class="layui-form-label">代码</label>', '<div class="layui-input-block">', '<textarea name="code" lay-verify="required" autofocus="true" class="layui-textarea" style="height: 200px;"></textarea>', "</div>", "</li>", '<li class="layui-form-item" style="text-align: center;">', '<button type="button" lay-submit lay-interceptor="layedit-code-yes" class="layui-btn"> 确定 </button>', '<button style="margin-left: 20px;" type="button" class="layui-btn layui-btn-primary"> 取消 </button>', "</li>", "</ul>"].join(""),
