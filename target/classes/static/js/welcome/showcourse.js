        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (status === "nologin") {
                    ...
                    $(".coursecontainer .container-top .collect").data("status","nologin");
                }
                else {
                ...
                $.ajax({
                    ...
                    success: function(data){
                        var status = data.status;
                        if(status === "collect"){
                            $(".coursecontainer .container-top .collect").data("status","collect");
                            $(".coursecontainer .container-top .collect").addClass("col").attr("title","点击取消收藏").find("span").text("已收藏");
                        }
                        else{
                            $(".coursecontainer .container-top .collect").data("status","uncollect");
                            $(".coursecontainer .container-top .collect").find("span").attr("title","点击收藏该课程").text("收藏");
                        }
                    },
                    error: function(xhr, status){
                        window.alert("后台环境异常导致无法获取收藏信息，请刷新页面重试");
