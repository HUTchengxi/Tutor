...
public class BbsCardCollectController {
    ...
    @RequestMapping("/getmycollectcount.json")
     ...
     */
    @RequireAuth(ident = "user", type = "api")
    @PostMapping("/checkcollectstatus.json")
     ...
     */
    @RequireAuth(ident = "user", type = "api")
    @PostMapping("/uncollectcard.json")
     ...
     */
    @RequireAuth(ident = "user", type = "api")
    @PostMapping("/getmycollectinfo.json")
