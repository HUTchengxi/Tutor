...
public class EmailUtil {
     ...
     * @param uuid
     */
    public static void sendCommonEmail(String email, String uuid) throws MessagingException {
        ...
        //设置抄送人
        mm.setRecipient(Message.RecipientType.CC, new InternetAddress(email));
        mm.setSubject("勤成家教网---邮箱找回密码");

        valicode = getUUID();
        mm.setContent("您的验证短码是："+valicode, "text/html;charset=utf-8");
